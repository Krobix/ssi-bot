...
class ToxicityHelper():
	...
	_detoxify = None
	_threshold_map = {'toxicity': 0.80, 'severe_toxicity': 0.05, 'obscene': 0.9, 'identity_attack': 0.4, 'insult': 0.4, 'threat': 0.3, 'sexual_explicit': 0.95}
	...
	def __init__(self, config_section='DEFAULT'):
		...
		self._detoxify = pipeline(model='unitary/unbiased-toxic-roberta', device=0 if cuda_available else 'cpu', max_length=512, truncation=True)
